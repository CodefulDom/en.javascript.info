...
![](../../.gitbook/assets/shadow-dom-user-card.svg)
...
\*/!\*  
 ...
 _!_ I like to swim. _/!_ John Smith 01.01.2001 _!_ ...And play volleyball too! _/!_ &lt;/user-card&gt;
...
\`\`\`html run untrusted height=80
 ...
 Candy menu &lt;/custom-menu&gt;

 customElements.define\('custom-menu', class extends HTMLElement { connectedCallback\(\) { this.attachShadow\({mode: 'open'}\); this.shadowRoot.innerHTML = `<div class="menu"> <slot name="title"></slot> <ul><slot name="item"></slot></ul> </div>`;
...
setTimeout\(\(\) =&gt; { menu.insertAdjacentHTML\('beforeEnd', ''\) }, 1000\);

setTimeout\(\(\) =&gt; { menu.querySelector\('\[slot="title"\]'\).innerHTML = "New menu"; }, 2000\); &lt;/script&gt;
