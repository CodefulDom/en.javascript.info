...
![](../../../.gitbook/assets/mouseover-mouseout.svg)
...
![](../../../.gitbook/assets/mouseover-to-child.svg)

That may seem strange, but can be easily explained.

**According to the browser logic, the mouse cursor may be only over a** _**single**_ **element at any time -- the most nested one and top by z-index.**
...
![](../../../.gitbook/assets/mouseover-bubble-nested.svg)
