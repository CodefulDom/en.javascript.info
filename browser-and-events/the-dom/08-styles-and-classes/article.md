...
\`\`\`html run
 ...
 for \(let name of document.body.classList\) { alert\(name\); // main, and then page } 
...
\`\`\`html run height=100
  ...
  _!_ // doesn't work! document.body.style.margin = 20; alert\(document.body.style.margin\); // '' \(empty string, the assignment is ignored\) _/!_
...
\`\`\`html run
 ...
 let style = getComputedStyle\(document.body\); alert\(style.margin\); // empty string in Firefox 
