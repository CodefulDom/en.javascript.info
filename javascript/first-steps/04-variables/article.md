...
A \[variable\]\([https://en.wikipedia.org/wiki/Variable\_\(computer\_science](https://en.wikipedia.org/wiki/Variable_%28computer_science)\)\) is a "named storage" for data. We can use variables to store goodies, visitors, and other data.
