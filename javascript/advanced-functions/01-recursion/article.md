...
![recursive diagram of pow](../../../.gitbook/assets/recursion-pow.svg)
...
\`\`\`js run function pow\(x, n\) { return \(n == 1\) ? x : \(x \* pow\(x, n - 1\)\); }
...
![linked list](../../../.gitbook/assets/linked-list.svg)
