...
// calculate and remember the result function process\(obj\) { if \(!cache.has\(obj\)\) { let result = / _calculations of the result for_ / obj;
...
// 📁 main.js let obj = {/ _let's say we have an object_ /};
