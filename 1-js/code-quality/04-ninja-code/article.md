...
\`\`\`quote author="Confucius" Learning without thought is labor lost; thought without learning is perilous.
...
\`\`\`quote author="Laozi \(Tao Te Ching\)" The Dao hides in wordlessness. Only the Dao is well begun and well completed.
...
\`\`\`quote author="Confucius" The hardest thing of all is to find a black cat in a dark room, especially if there is no cat.
...
\`\`\`quote author="Guan Yin Zi" When in the light, can't see anything in the darkness.  
