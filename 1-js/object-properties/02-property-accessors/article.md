...
The second type of properties is something new. It's _accessor properties_. They are essentially functions that work on getting and setting a value, but look like regular properties to an external code.
